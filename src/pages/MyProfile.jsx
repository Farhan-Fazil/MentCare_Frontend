...
const MyProfile = () => {
    ...
    return userData ? (
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5 mx-auto my-5'>
            ...
            {isEdit ? (
                ...
                <p className='font-medium text-3xl text-[#ffffff] mt-4'>{userData.name}</p>
            )}
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-[#363636]'>
                    <p className='font-medium text-amber-300'>Email id:</p>
                    <p className='text-white'>{userData.email}</p>

                    <p className='font-medium text-amber-300'>Phone:</p>
                    {isEdit ? (
                    ...
                    <p className='font-medium text-amber-300'>Address:</p>
                    {isEdit ? (
                        <p>
            ...
            <div>
                <p className='text-[#ffffff] underline mt-3'>BASIC INFORMATION</p>
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-gray-600'>
                    <p className='font-medium text-amber-300'>Gender:</p>
                    {isEdit ? (
                    ...
                    <p className='font-medium text-amber-300'>Birthday:</p>
                    {isEdit ? (
