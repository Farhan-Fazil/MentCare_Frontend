...
const Footer = () => {
  return (
    <>
      <footer className="bg-[#172554] w-screen overflow-hidden max-sm:-mx-2">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <a href="#" className="flex items-center">
                <span className="text-heading self-center text-3xl font-semibold whitespace-nowrap">Ment<span className='text-amber-300'>Care</span></span>
              </a>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                ...
                <ul className="text-body font-medium">
                  <li className="mb-4">
                    <a href="" className="hover:underline">MentCare</a>
                  </li>
                  <li>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-body sm:text-center">© 2026 <a href="https://flowbite.com/" className="hover:underline">MentCare™</a>. All Rights Reserved.
            </span>
